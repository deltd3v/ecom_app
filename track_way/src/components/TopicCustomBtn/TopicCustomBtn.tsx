...
import { Text, Alert, GestureResponderEvent, Pressable, StyleSheet, PressableProps, ButtonProps } from 'react-native'
import React from 'react'
import Colors from '../../constants/Colors';


interface P extends PressableProps { title?: string; }
